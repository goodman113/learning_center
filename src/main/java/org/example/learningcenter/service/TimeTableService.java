...
public class TimeTableService extends AbstractService<
    ...
    public List<TimeTableDto> getAll(List<Days> days, LocalTime start, LocalTime end) {
        List<TimeTableProjection> projection = repository.getAllTimeTableByFilter(days,start,end);
